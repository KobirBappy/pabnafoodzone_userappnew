...
import 'package:appmartbduser/helper/notification_helper.dart';
import 'package:appmartbduser/helper/responsive_helper.dart';
import 'package:appmartbduser/helper/route_helper.dart';
import 'package:appmartbduser/theme/dark_theme.dart';
import 'package:appmartbduser/theme/light_theme.dart';
import 'package:appmartbduser/util/app_constants.dart';
import 'package:appmartbduser/util/messages.dart';
...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: FirebaseOptions(
       apiKey: 'AIzaSyBZrS11mySxKInglHKAHf0mCeppIQPvZQU',
      appId: '1:270549085675:android:6e08ea41aa9c1cd9d03dae',
      messagingSenderId: '270549085675',
      projectId: 'pabnamartam',
    ));
  }
